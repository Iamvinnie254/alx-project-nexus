    ...
    return (
      <div className="text-center py-20">
        ...
        <button
          ...
          className="bg-linear-to-r from-emerald-600 to-green-600 text-white px-8 py-3 rounded-2xl hover:from-emerald-700"
        >
          Go to Login →
        </button>
      </div>
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-4xl font-bold bg-linear-to-r from-emerald-600 to-green-600 bg-clip-text text-transparent">
          Shopping Cart
        </h1>
              ...
              <div className="flex gap-6 lg:gap-8 items-start">
                ...
                <div className="flex items-center gap-4 self-start">
                  <button
                    ...
                    className="w-14 h-14 bg-linear-to-r from-emerald-500 to-green-600 text-white rounded-2xl font-bold text-xl shadow-lg hover:shadow-xl transition-all"
                  >
                    −
                  </button>
                  <span className="text-3xl font-black w-20 text-center min-w-20">
                    {item.quantity}
                  </span>
                  <button
                    onClick={() => updateQuantity(item.id, item.quantity + 1)}
                  ...
                  <button
                    ...
                    className="p-4 bg-red-600 hover:bg-red-700 text-white rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all"
                  >
                    🗑️
                  </button>
                </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-3xl shadow-2xl p-10 border border-emerald-100 sticky top-12">
            ...
            <button
              ...
              className="w-full bg-linear-to-r from-emerald-600 to-green-600 text-white py-6 px-8 rounded-3xl text-xl font-black shadow-2xl hover:shadow-3xl hover:from-emerald-700 transform hover:-translate-y-1 transition-all mb-6"
            >
              Proceed to Checkout →
            </button>
